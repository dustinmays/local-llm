...
export const DelegateResultSchema = z
  .object({
    ...
    prompt_tokens_estimate: z.number().int().nonnegative(),
    prompt_tokens_actual: z.number().int().nonnegative().nullable(),
    completion_tokens_actual: z.number().int().nonnegative().nullable(),
    context_utilization_percent: z.number().min(0).max(100).nullable(),
    truncated: z.boolean(),
